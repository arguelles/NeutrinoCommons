...
class PhysicsConstants():
    ...
    def __init__(self):
        ...
        cdef str self.name = "STD"                    # Default values
        ...
        self.th12 = np.arctan(np.sqrt(0.4))#np.arcsin(np.sqrt(0.32))#
        self.th13 = 0.154085 # daya bay paper 12.03
